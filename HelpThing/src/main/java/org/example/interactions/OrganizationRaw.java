...
public class OrganizationRaw implements Serializable {
    ...
    public OrganizationRaw(String name, Coordinates coordinates, float annualTurnover, Integer employeesCount, OrganizationType type, Address postalAddress) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.annualTurnover, annualTurnover) == 0 && name.equals(that.name) &&
                coordinates.equals(that.coordinates) && employeesCount.equals(that.employeesCount) &&
